        ...
        <table class="table" style="color: #eff1f4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="{{ asset('storage').'/'.$herra->imagen}}" class="img-thumbnail img-fliud" alt="" width="100"></td>
                    <td>{{$herra->nombre}}</td>  
                ...
                <table class="table" style="color: #eff1f4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('storage').'/'.$herraFilt->imagen}}" class="img-thumbnail img-fliud" alt="" width="100"></td>
                            ...
                            <form action="crear-registro-herramientas-cambiarHerramienta" method="post">
                                @csrf                                

                                <td><button class="btn btn-success" name="idHerramienta" value="{{$herraFilt->id}}" type="submit" >Seleccionar</button></td>    

  ...
  <img src="{{ asset('storage').'/'.$producto->imagen}}" class="img-thumbnail img-fliud" alt="" width="100">
              ...
              <img src="{{ asset('storage').'/'.$producto->imagen}}" class="img-thumbnail img-fliud" alt=""
                ...
                <div class="col-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="padding: 0px;shape-outside: none">
                            ...
                            <form action="rh-pedido-generar" class="" method="post"
                                style="background-color: transparent;padding-top: 0px;padding-bottom: 2%">
                                @csrf
                                <button class="btn btn-primary" class="" name="asignarHerramientas"
                                    type="submit">Asignar herramientas automaticamente </button>
                            </form>
                        </div>
                        ...
                        <div class="col">
                            <div class="col" style="padding: 0px;shape-outside: none">
                                ...
                                <form action="volcal-registrar-herramientas" class="" method="post"
                                    style="background-color: transparent;padding-top: 15px;padding-bottom: 2%">
                                    @csrf
                                    <button class="btn btn-danger bg-success" class="" name="asignarHerramientas"
                                        type="submit">Asignar herramientas al pedido</button>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="" style="background-color: transparent;">
                        <div class="">
                            ...
                            <div class="card">
                                            ...
                                            <table class="table" style="color: #eff1f4">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('storage').'/'.$herramientaAsignada->imagen}}"
                                ...
                                @csrf
                                <td><button class="btn btn-danger" name="idHerramienta" value="{{$herramientaAsignada->id}}"
                ...
                <table class="table" style="color: #eff1f4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('storage').'/'.$herramienta->imagen}}" class="img-thumbnail
                img-fliud" alt="" width="100"></td>
                ...
                <form action="crear-registro-herramientas-agregar" method="post">
                    ...
                    <td><button class="btn btn-success" name="idHerramienta" value="{{$herramienta->id}}"
